...
public class QuizWeather extends AppCompatActivity implements View.OnClickListener {
    TextView alphabet;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_weather);
    ...
    public void onClick(View v) {
        if (counter == 1) {
            if (v == img1) {
                ...
                alphabet.setText("Which Weather is Sunny?");
            ...
            if (v == img1) {mp.start();
                ...
                alphabet.setText("Which Weather is Snowy?");
                img1.setImageResource(R.drawable.snowfall);
                mediaPlayer.start();
                img2.setImageResource(R.drawable.windy);
                img3.setImageResource(R.drawable.lightning);
                counter++;
            }
        } else if (counter == 3) {
            if (v == img1) {
                alphabet.setText("Which Weather is Windy?");
                img1.setImageResource(R.drawable.snowfall);
                img2.setImageResource(R.drawable.tornado);
                img3.setImageResource(R.drawable.windy);
                mediaPlayer.start();
                counter++;
            } else if (v == img2) {mp.start();
                customToastClick(v);
            ...
            if (v == img1) {mp.start();
                ...
                alphabet.setText("Which Weather is lightning?");
                mediaPlayer.start();
                img1.setImageResource(R.drawable.rainy);
                img2.setImageResource(R.drawable.lightning);
                img3.setImageResource(R.drawable.partlycloudy);
                counter++;
            }
        } else if (counter == 5) {
            if (v == img1) {mp.start();
                ...
                alphabet.setText("Which Weather is Tornado?");
                img1.setImageResource(R.drawable.tornado);
                mediaPlayer.start();
                img2.setImageResource(R.drawable.lightning);
                img3.setImageResource(R.drawable.sunny);
