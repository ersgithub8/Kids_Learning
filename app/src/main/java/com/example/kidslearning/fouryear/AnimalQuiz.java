...
public class AnimalQuiz extends AppCompatActivity implements View.OnClickListener {
    TextView alphabet;
    ...
    public void onClick(View v) {
        if (counter == 1) {
            if (v == img1) {
                ...
                alphabet.setText("Which one is Camel?");
                img1.setImageResource(R.drawable.cat);

                mediaPlayer.start();

                img2.setImageResource(R.drawable.machli);
                img3.setImageResource(R.drawable.camel);
                counter++;
            } else if (v == img3) {
                mp.start();
                customToastClick(v);
            ...
            if (v == img1) {mp.start();
                ...
                alphabet.setText("Which one is Horse?");
                img1.setImageResource(R.drawable.horse);
                mediaPlayer.start();
                img2.setImageResource(R.drawable.sheep);
                img3.setImageResource(R.drawable.cow);
                counter++;
            }
        } else if (counter == 3) {
            if (v == img1) {
                alphabet.setText("Which one is Goat?");
                img1.setImageResource(R.drawable.cat);
                img2.setImageResource(R.drawable.camel);
                img3.setImageResource(R.drawable.goatt);
                mediaPlayer.start();
                counter++;
            } else if (v == img2) {mp.start();
                customToastClick(v);
            ...
            if (v == img1) {mp.start();
                ...
                alphabet.setText("Which one is Sheep?");
                mediaPlayer.start();
                img1.setImageResource(R.drawable.horse);
                img2.setImageResource(R.drawable.sheep);
            ...
            if (v == img1) {mp.start();
                ...
                alphabet.setText("Which one is cat?");
                img1.setImageResource(R.drawable.cat);
                mediaPlayer.start();
                img2.setImageResource(R.drawable.camel);
                img3.setImageResource(R.drawable.goatt);
